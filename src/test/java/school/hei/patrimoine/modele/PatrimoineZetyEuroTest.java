...
public class PatrimoineZetyEuroTest {
    ...
    void valeur_patrimoine_zety_le_26_octobre_2025_en_euros() {
        ...
        var espece = new Argent("Espèces", au3juillet24, au3juillet24, 800_000);
        var compteBancaire = new Argent("Compte bancaire", au3juillet24, au3juillet24, 100_000);
        ...
        var dette = new Dette("Dette en €", LocalDate.of(2025, Month.FEBRUARY, 15), -7000);
        ...
        int valeurComptableEnEuros = patrimoineZety.getValeurComptableEnDevise("€", tauxChangeInitial, appreciationAnnuelle);
